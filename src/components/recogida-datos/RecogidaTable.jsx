          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-border bg-secondary/50">
                ...
                <th className="text-left px-4 py-3 text-xs font-semibold text-muted-foreground uppercase tracking-wider">€/hora</th>
              ...
              {filtered.length === 0 ? (
                ...
                filtered.map(w => (
                  <tr key={w.id} className="hover:bg-secondary/30 transition-colors">
                    ...
                    <td className="px-4 py-3 text-sm font-medium text-[hsl(35,92%,55%)]">{w.precioHora ? `${w.precioHora.toFixed(2)}€` : '—'}</td>
